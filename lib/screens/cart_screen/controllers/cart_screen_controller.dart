...
class CartScreenController extends GetxController {
  ...
  void calculateTotal(List<Product> cart,
      {int discountRateIsPercent = 5}) {
    subtotal.value = calculateSubtotal(cart);
    discount.value =
        calculateDiscount(cart, discountRateIsPercent: discountRateIsPercent);
    totel.value = subtotal.value - discount.value;
  }
  ...
  double calculateDiscount(List<Product> cart,
      {int discountRateIsPercent = 5}) {
    final discountRate = discountRateIsPercent / 100;
